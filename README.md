...
* [Generating Seeds with a True Random Number Generator](https://github.com/johnshearing/IOTA-Airgapped-NodeJS-Console-Wallet/blob/master/README.md#generating-seeds-with-a-true-random-number-generator)  
...
* A warning about brain wallets. **Do not use them**  
  ...
  * The attacker then dedicates computers to scan the Tangle looking for addresses generated by brain wallets in the dictionary.  
...
* **Citizens are about to get a seat at the government bargaining table along side big corporations and big banks**  
...
* Now you are ready to master NodeJS. The following video playlist will help:  
